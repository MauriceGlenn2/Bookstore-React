...
function Cart({ cart, changeQuantity, removeItem }) {
    const total = () => {
        ...
        cart.forEach((item) => {
            price += +(
                (item.salePrice || item.oringalPrice) * item.quantity)
        })
        return price
    }
                                        ...
                                        return (
                                            <div className="cart__item">
                                                <div className="cart__book">
                                                    <img src="https://covers.openlibrary.org/b/id/7737110-L.jpg"
                                                ...
                                                <div className="cart__total">
                                                    ${(book.salePrice || book.oringalPrice * book.quantity).toFixed(2)}
                                                </div>
                                            </div>
                                        )
                                    })
